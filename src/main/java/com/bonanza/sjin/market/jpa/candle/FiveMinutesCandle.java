package com.bonanza.sjin.market.jpa.candle;
...
import com.bonanza.sjin.market.upbit.candle.Candle;
...
@Table(
        name = "tb_five_minutes_candle",
        indexes = {
                @Index(name = "tb_five_minutes_candle_idx1", columnList = "market,candle_date_time_utc"),
                @Index(name = "tb_five_minutes_candle_idx2", columnList = "market,candle_date_time_kst desc,timestamp"),
                @Index(name = "tb_five_minutes_candle_idx3", columnList = "market,candle_date_time_kst"),
                @Index(name = "tb_five_minutes_candle_idx4", columnList = "market,timestamp"),
                @Index(name = "tb_five_minutes_candle_idx5", columnList = "market,timestamp,trade_market")
        }
)
@Entity
