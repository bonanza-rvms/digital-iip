...
import com.bonanza.sjin.market.upbit.enums.OrdSideType;
import com.bonanza.sjin.market.upbit.enums.OrdType;
import com.bonanza.sjin.market.upbit.request.MarketOrderableRequest;
import com.bonanza.sjin.market.upbit.request.OrderCancelRequest;
import com.bonanza.sjin.market.upbit.request.OrderListRequest;
import com.bonanza.sjin.market.upbit.request.SingleOrderRequest;
import com.bonanza.sjin.market.upbit.result.orders.MarketOrderableResult;
import com.bonanza.sjin.market.upbit.result.orders.OrderCancelResult;
import com.bonanza.sjin.market.upbit.result.orders.OrderResult;
import com.bonanza.sjin.market.upbit.result.orders.SingleOrderResult;
...
public class UpbitOrderClient {
    ...
    public MarketOrderableResult getMargetOrderableInfo(MarketOrderableRequest marketOrderableRequest) {
        try {
            ...
            URI uri = URI.create(properties.getApiUrl() + "/v1/orders/chance?" + queryString);
    ...
    public SingleOrderResult singleOrderRequest(SingleOrderRequest singleOrderRequest) {
        try {
            ...
            URI uri = URI.create(properties.getApiUrl() + "/v1/order?" + queryString);
    ...
    public List<OrderResult> getOrderListInfo(OrderListRequest orderRequest) {
        try {
            ...
            URI uri = URI.create(properties.getApiUrl() + "/v1/orders?" + queryString);
    ...
    private OrderResult order(String market, OrdSideType ordSideType, String volume, String price, Double percent) {
        try {
            ...
            URI uri = URI.create(properties.getApiUrl() + "/v1/orders");
            ResponseEntity<String> response = restTemplate.exchange(
                    uri,
                    HttpMethod.POST,
