...
import com.bonanza.daip.config.enums.BithumbConfig;
...
import com.bonanza.daip.market.bithumb.candle.BithumbMinuteCandle;
import com.bonanza.daip.market.bithumb.client.BithumbCandleClient;
import com.bonanza.daip.market.bithumb.enums.BithumbMarketType;
import com.bonanza.daip.market.coinone.result.CoinOneMarketCode;
import com.bonanza.daip.market.coinone.result.CoinOneMarketCode.CurrencyUnit;
...
import com.bonanza.daip.market.upbit.client.UpbitCandleClient;
import com.bonanza.daip.market.upbit.enums.MarketType;
import com.bonanza.daip.market.upbit.enums.MinuteType;
import com.bonanza.daip.market.upbit.result.MarketCode;
import com.bonanza.daip.market.upbit.result.TradeResult;
import com.bonanza.daip.repository.CoinCodeRepository;
import com.bonanza.daip.repository.FiveMinutesCandleRepository;
import com.bonanza.daip.repository.OneMinutesCandleRepository;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public List<CoinCode> collectCoinByUpbit() throws Exception {
		...
		for (MarketCode code : list) {
			String coinCode = code.getMarket()
					.replaceAll("KRW", "")
					.replaceAll("-", "")
					.replaceAll("_", "");
			
			CoinCode coin = coinCodeRepository.findByCode(coinCode);
    ...
    public List<CoinCode> collectCoinByCoinOne() throws Exception {
		...
		if ("success".equals(ccList.getResult())) {
			for (CurrencyUnit code : ccList.getMarkets()) {
				...
				String coinCode = code.getTarget_currency()
						.replaceAll("KRW", body)
						.replaceAll("-", "")
						.replaceAll("_", "");
