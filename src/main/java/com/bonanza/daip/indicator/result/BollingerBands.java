package com.bonanza.daip.indicator.result;
...
public class BollingerBands {
     ...
     * @return
     */
    public boolean isBollingerBandUddTouch(OneMinutesCandle candle) {
     ...
     * @return
     */
    public boolean isBollingerBandLddTouch(OneMinutesCandle candle) {
        if (Objects.isNull(candle)) {
            return false;
        }
